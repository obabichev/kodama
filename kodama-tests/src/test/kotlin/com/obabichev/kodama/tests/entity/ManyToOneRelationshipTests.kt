...
import com.obabichev.kodama.tests.entity.impl.User  // Factory function
        ...
        withConnection {
            EntitySession(this.connection).use { session ->
                with(session) {
                    ...
                    val user1 = order1.user()
                    val user2 = order2.user()
                    val user3 = order3.user()
        ...
        withConnection {
            EntitySession(this.connection).use { session ->
                with(session) {
                    ...
                    val alice1 = aliceOrder1.user()
                    val alice2 = aliceOrder2.user()
                    val bob = bobOrder.user()
