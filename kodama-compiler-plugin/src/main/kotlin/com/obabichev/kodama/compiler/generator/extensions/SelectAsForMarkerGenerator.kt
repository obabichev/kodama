...
class SelectAsForMarkerGenerator(
    ...
    override fun generate(): String = buildString {
        ...
        appendLine("inline fun <$selectionParams, JP : JoinPattern>")
        appendLine("${queryCombination.builderClassName}<$selectionParams, $fromType, JP>.selectAs(")
        appendLine("    marker: ${marker.interfaceName}<*>,")
        appendLine("    crossinline selection: $contextClassName.() -> Any")
        appendLine("): ${queryCombination.builderClassName}<$selectionParams, $toType, JP> {")
